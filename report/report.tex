...
The used for the training and running all the above tests was <SPEC OF NUS CLUSTER SERVER USED>
...
Implementing HAS\_LOST forces our agent against making a losing move, if there
are other moves that can prolong the game.
...
\begin{thebibliography}{9}
    \bibitem{colin_fahey}
    Colin P. Fahey, Tetris AI, 2003 \\\texttt{https://www.colinfahey.com/tetris/tetris.html}
\end{thebibliography}
